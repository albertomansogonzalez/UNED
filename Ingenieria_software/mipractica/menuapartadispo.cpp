...
void MenuApartaDispo::mostrar()
{
    ...
    std::cout << std::endl << "El edificio "<< gesRAE.getEdicicio(idEdificio).getNombre() << "desde el " << entrada.toString() << " y " << duracion << " dias de estancia, tendria disponibles:" << std::endl << std::endl;
